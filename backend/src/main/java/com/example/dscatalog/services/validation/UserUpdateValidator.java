...
public class UserUpdateValidator implements ConstraintValidator<UserUpdateValid, UserUpdateDTO> {
	...
	@Autowired
	private HttpServletRequest request; //guarda informacoes da requisicao, a partir dele eh possivel pegar o id passado na requisicao para fazer o update
	...
	public boolean isValid(UserUpdateDTO dto, ConstraintValidatorContext context) {
		...
		if (user != null && userId != user.getId()) {
			list.add(new FieldMessage("email", "Email ja existe no banco de dados"));
		}
